...
class Connect_db
{
    ...
    // Order Tiket
    function set_Pesanan($id_tiket, $order_id, $email, $catatan, $haripendakian, $jlrturun, $usia, $bb, $tb, $alamat, $rek_pengirim, $namarek_pengirim, $bank_pengirim, $bank_penerima, $total_pembayaran, $waktu_pesanan, $bukti_pembayaran, $status, $link_status, $warna_status)
    {
        $sql = "INSERT INTO user_order(id,id_tiket ,order_id, email, catatan, haripendakian, jlrturun, usia, bb, tb, alamat, rek_pengirim, namarek_pengirim, bank_pengirim, , bank_penerima, total_pembayaran, waktu_pesanan,bukti_pembayaran, status, link_status, warna_status)
               VALUES
               ('', '$id_tiket', '$order_id', '$email', '$catatan', '$haripendakian', '$jlrturun', '$usia', '$bb', '$tb', '$alamat', '$rek_pengirim', '$namarek_pengirim', '$bank_pengirim',  '$bank_penerima', '$total_pembayaran', '$waktu_pesanan', '$bukti_pembayaran', '$status', '$link_status', '$warna_status') 
        ";
        if (mysqli_query($this->connect_db, $sql)) {
            echo '<script>';
