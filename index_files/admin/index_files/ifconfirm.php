...
$conn = mysqli_connect("localhost", "root", "", "tempest");
mysqli_query(
    $conn,
    "UPDATE user_order set id = '$id', id_tiket = '$id_tiket', order_id = '$order_id', email = '$email', catatan = '$catatan', rek_pengirim = '$rek_pengirim', namarek_pengirim = '$namarek_pengirim', bank_pengirim = '$bank_pengirim', bank_penerima = '$bank_penerima', total_pembayaran = '$total_pembayaran', waktu_pesanan = '$waktu_pesanan', bukti_pembayaran = '$bukti_pembayaran', status = '$status', link_status = '$link_status', warna_status = '$warna_status' WHERE id = '$id'"
);
